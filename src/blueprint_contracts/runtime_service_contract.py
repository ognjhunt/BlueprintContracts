"""Shared runtime-service metadata contract for site-world backends.

This module defines the portable runtime-kind vocabulary and the metadata shape
used by Pipeline, Validation, WebApp, and any future native serving runtime.
The contract is shared policy; backend implementations remain repo-local.
"""
